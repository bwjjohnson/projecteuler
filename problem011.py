#!/usr/bin/python
#
# Project Euler (projecteuler.net) - Problem 11
# In the 220 grid below, four numbers along a diagonal line have been marked in 
...
# vertical
for x in range(dim-num+1):
  for y in range(dim):
    prod = grid[x][y] * grid[x+1][y] * grid[x+2][y] * grid[x+3][y]
    if prod > gp: gp = prod
# horizontal
for x in range(dim):
  for y in range(dim-num+1):
